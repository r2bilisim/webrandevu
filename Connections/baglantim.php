<?php
	/*
		-- =============================================
		-- Author:		EKOMURCU
		-- Create date: 2018-06-29 20:20:40
		-- Description:	Veritabanı ve ayarlar
		-- ============================================= 
	*/
	$vt_turu="Mssql"; //Mssql veya Mysql seçebilirsiniz.
	$sunucu="EKOMURCU"; //Mssql için localhost veya EKOMURCU\SQLEXPRESS
	...
	//finally blogu php5.5 sonrasında aktif omes.net sunucusu eski sürüm kullanıyor
	finally
	{
		ob_start();
	}
