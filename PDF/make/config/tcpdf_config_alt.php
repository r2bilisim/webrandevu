 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', dirname(__FILE__).'/../../../dist/images/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Huawei');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Huawei Teknik Servis');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Huawei Teknik Servis');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Huawei Teknik Servis \nwww.huawei.com.tr");
