								...
								<form id="RandevuForm1" name="RandevuForm1" class="form-inline" data-toggle="validator">
									...
									<?php if($epostaAyar['Aktif'])
										...
										<strong>Eposta Adresiniz:&nbsp;</strong><div class="wrap-input100 validate-input">
											<input data-error="hatalı email" type="text" value="<?php if($kullanici['musteriEposta']!="admin@admin.com"){ echo $kullanici['musteriEposta'];}  ?>" id="eposta" autocomplete="off"  name="eposta" placeholder="Geçerli bir eposta adresi giriniz"  class="input100"  maxlength="120">						
											<span class="focus-input100"></span>
											<span class="symbol-input100">
										...
										<?php }else{
										?>
										<input type="hidden" value="admin@admin.com" id="eposta" >	
										<?php
										}?>	
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<h4>Huawei Teknik Servis</h4>
									<button type="button" id="clsBtn" class="btn btn-danger" data-dismiss="modal"><?php echo $diller['kapat']; ?></button>		
								</div>
							</div>
						</div>
					</div>
