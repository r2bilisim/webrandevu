...
-- Description:	tc kimlik doğrulama scripti -> (normalde js kodu ancak çoklu dil desteği için uzantı php ye çevrildi)
-- ============================================= 
 */
?>
...
function dogrula()
    {
      ...
      {
	  $( "#mesaj" ).text("<?php echo $diller['tcUyariMesaj'];?>");
                   ...
                   success:function(data){
				    ...
				    error:function(ma,ydin)
					{
						if (ma.status === 0) {
							...
							alert('[jquery]İstenen JSON ayrıştırması başarısız'+ma.responseText);
